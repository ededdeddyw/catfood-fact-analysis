...
SUB_BRANDS = {
    ...
    "日本ヒルズ・コルゲート株式会社": ["サイエンスダイエット", "サイエンス・ダイエット", "ヒルズ"],
    "ネスレ日本株式会社　ネスレピュリナペットケア": ["モンプチ", "ピュリナ", "フィリックス", "プロプラン"],
    "マース・ジャパン・リミテッド": ["カルカン", "ニュートロ", "シーバ"],
    "ユニ・チャーム株式会社": ["銀のスプーン", "ねこ元気", "allwell", "オールウェル"],
    "はごろもフーズ株式会社": ["無一物", "ねこまんま"],
    "ライオンペット株式会社": ["petkiss", "ペットキッス"],
    "デビフペット株式会社": ["デビフ", "カリユド"],
    "株式会社ペティオ": ["ペティオ", "プラクト"],
}
